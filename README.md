...
This fork is for personal use and is not intended to be used by others.

> `./gradlew build && cp ./fabric/build/libs/baritone-api-fabric-1.21.4-SNAPSHOT.jar "C:\Users\Admik\AppData\Roaming\.minecraft\mods\baritone-api-fabric-1.21.4-SNAPSHOT.jar" && c:\/Users\/Admik\/AppData\/Roaming\/.minecraft\/TLauncher.exe`
## Changes
Added algorithm to avoid mine fake ore blobs generated by anti-xray plugins. (Works only when blobs are generated for some specific blocks, like gravel)

## Original README
It is a fork of the original Baritone repository by cabaletta. The original README.md is included below.
